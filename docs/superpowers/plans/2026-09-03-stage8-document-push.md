...
| PR-4 «Правило компании» | `auto / manual / never` и набор типов в «Реквизитах исполнителя» у администратора и руководителя, автопостановка после выпуска best-effort | `У-169` (правило) | 🔨 [#PRNUM](https://github.com/aiprocadm/lk_otsfera/pull/PRNUM) в ревью |
