...
| PR-10 «Видимость ошибок» | Светофор «документов не выгружено: N», каждая попытка в истории, порог алерта по `У-126`, уведомление об окончательном отказе | `У-174` | 🔨 [#492](https://github.com/aiprocadm/lk_otsfera/pull/492) в ревью |
