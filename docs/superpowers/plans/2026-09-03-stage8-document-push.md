...
| PR-7 «Реквизиты контрагента» | Реквизиты в схеме, маппере и writer'е; пустое из 1С не затирает заполненное; фикстуры, набор данных mock и контракт | `У-171` (`Д-23`) | 🔨 [#489](https://github.com/aiprocadm/lk_otsfera/pull/489) в ревью |
