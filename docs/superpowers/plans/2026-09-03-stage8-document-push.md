...
| PR-7 «Реквизиты контрагента» | Реквизиты в схеме, маппере и writer'е; пустое из 1С не затирает заполненное; фикстуры, набор данных mock и контракт | `У-171` (`Д-23`) | 🔨 [#PR7](https://github.com/aiprocadm/lk_otsfera/pull/PR7) в ревью |
