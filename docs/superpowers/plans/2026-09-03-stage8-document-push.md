...
| PR-8 «Сверка» | `findDocument` в адаптере, поштучная сверка `pushed`, `failed: missing_in_1c`, зависшие лиды | `У-172` (`Д-26`) | 🔨 [#PR8](https://github.com/aiprocadm/lk_otsfera/pull/PR8) в ревью |
