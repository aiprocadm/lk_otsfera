...
| PR-9 «Файловый канал» | Вкладка «Выгрузка документов»: фильтр → Excel-реестр + ZIP, отметка `exported_file`, пакет в «Истории» | `У-173` | 🔨 [#PRN](https://github.com/aiprocadm/lk_otsfera/pull/PRN) в ревью |
