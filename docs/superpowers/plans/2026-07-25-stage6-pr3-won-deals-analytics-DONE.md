# Close-out — План — Этап 6 / PR-3: «Выиграно сделок» в план/факт руководителя (ФТ-4.5)

План: [2026-07-25-stage6-pr3-won-deals-analytics.md](2026-07-25-stage6-pr3-won-deals-analytics.md) · PR [#229](https://github.com/aiprocadm/lk_otsfera/pull/229) ✅ в `main`.
