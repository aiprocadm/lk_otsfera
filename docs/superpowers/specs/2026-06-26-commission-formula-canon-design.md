...
- R2 (зажим в 0 при отрицательном нетто-месяце) — подтвердить на гейте ревью спеки (раздел 3). R0 (НДС) уже решён владельцем.
