...
- [docs/tz/STATUS.md](tz/STATUS.md) — **какое ТЗ действующее и что делать дальше** (единственный источник правды о прогрессе). Сейчас действующее — [ТЗ единой логики кабинетов, документов для заказчика и интеграций из интерфейса](tz/2026-08-21-tz-cabinets-documents-integrations.md) (99 требований `У-78`…`У-176`, 10 этапов, реестр дефектов `Д-1`…`Д-40`; программа **закрыта 05.09.2026** — [close-out](tz/2026-09-05-tz-cabinets-program-DONE.md), действует режим сопровождения по [MAINTENANCE.md](tz/MAINTENANCE.md)); [ТЗ понятности интерфейса](tz/2026-08-08-tz-usability-and-core-gaps.md) закрыто 13.08.2026 и остаётся описанием ожидаемого поведения; [ТЗ продукта v0.5](tz/2026-07-29-tz-lk-otsfera-v0.5.md) — справочник по продукту; [ТЗ починки импорта 1С](tz/2026-08-04-tz-fix-1c-import.md) закрыто 07.08.2026.
