...
- [docs/tz/STATUS.md](tz/STATUS.md) — **какое ТЗ действующее и что делать дальше** (единственный источник правды о прогрессе). Сейчас действующее — [ТЗ: CRM для отдела продаж — замена Битрикс24](tz/2026-09-12-tz-crm-bitrix-replacement.md) (12.09.2026; тонкий индекс, полный пакет из 17 файлов — [docs/specs/](specs/README.md); 93 требования `У-177`…`У-269`, 11 этапов 0–10, решения `Р-Б-1`…`Р-Б-12`, дефекты `Д-41`/`Д-42`/`Д-43`/`Д-47`/`Д-49`); предыдущее — [ТЗ единой логики кабинетов, документов для заказчика и интеграций из интерфейса](tz/2026-08-21-tz-cabinets-documents-integrations.md) (99 требований `У-78`…`У-176`, **закрыта 05.09.2026** — [close-out](tz/2026-09-05-tz-cabinets-program-DONE.md)); режим сопровождения по [MAINTENANCE.md](tz/MAINTENANCE.md) продолжает действовать для хотфиксов; [ТЗ понятности интерфейса](tz/2026-08-08-tz-usability-and-core-gaps.md) закрыто 13.08.2026 и остаётся описанием ожидаемого поведения; [ТЗ продукта v0.5](tz/2026-07-29-tz-lk-otsfera-v0.5.md) — справочник по продукту; [ТЗ починки импорта 1С](tz/2026-08-04-tz-fix-1c-import.md) закрыто 07.08.2026.
...
- [docs/tz/MAINTENANCE.md](tz/MAINTENANCE.md) — **реестр проверок режима сопровождения** (`С-1`…`С-10`): что делает агент по фразе «продолжай по ТЗ», когда этапов не осталось. Протокол — CLAUDE.md §14, §9 действующего ТЗ.
