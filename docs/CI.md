...
## Branch protection (настроить в GitHub → Settings → Branches, ветка `main`)

Рекомендуемый минимум (мержит только владелец):

- Require a pull request before merging (без прямых push в main);
