...
export async function moveFunnelLeadAction(
  fd: FormData
): Promise<ActionResult<MoveFunnelLeadError>> {
...
export async function createFunnelStageAction(
  fd: FormData
): Promise<ActionResult<FunnelStageErrorCode> & { id?: string }> {
  const session = await requireSession();
...
export async function updateFunnelStageAction(
  fd: FormData
): Promise<ActionResult<FunnelStageErrorCode>> {
  const session = await requireSession();
  const id = str(fd, 'id');
...
export async function deleteFunnelStageAction(
  fd: FormData
): Promise<ActionResult<FunnelStageErrorCode>> {
  const session = await requireSession();
  const id = str(fd, 'id');
