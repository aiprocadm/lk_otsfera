    ...
    <main className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-[#111111] p-12 text-white">
        <div className="flex items-center gap-3">
          <span className="w-10 h-10 rounded-lg bg-[#F97316] flex items-center justify-center font-black text-white text-lg">
            П
          </span>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-lg">
            Управление заказами, документами и командой в одном месте.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <span className="w-8 h-8 rounded-md bg-[#F97316] flex items-center justify-center font-black text-white text-sm">
              П
            </span>
