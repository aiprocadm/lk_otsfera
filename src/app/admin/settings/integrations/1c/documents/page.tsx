...
/**
 * Вкладка «Выгрузка документов» администратора (`У-173`, этап 8): пакет
 * документов для 1С файлом. Экран общий с соседним кабинетом (правило зеркала
 * §15); база — здесь, в слое app. Администратор видит документы всех компаний —
 * скоуп режет сервис, а не страница.
 */
export default async function AdminOneCDocumentsPage({
  searchParams,
}: {
