    ...
    <div className="space-y-5">
      <div>
        <PageHeader
          ...
          subtitle="Разовая ручная загрузка «чистого» Excel-файла из 1С с тремя листами: «Контрагенты», «Реализации», «Поступления». Загружает заказы и оплаты. Предпросмотр покажет план изменений до применения."
        />
      </div>
      <div className="text-sm text-blue-800 bg-blue-50 border border-blue-100 rounded-lg px-4 py-3">
        ...
        Это не то же самое, что «Импорт оплат»: там загружается банковская выписка одним листом. А
        постоянный автоматический обмен с 1С по сети настраивается в разделе «Синхронизация (авто)».
      </div>
