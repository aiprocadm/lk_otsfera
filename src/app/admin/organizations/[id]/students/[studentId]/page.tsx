...
/** Карточка сотрудника внутри карточки организации у администратора (`У-97`). */
export default async function AdminOrgEmployeePage({
  params,
}: {
  ...
  return (
    <div className="space-y-5">
      <Breadcrumbs
        items={buildOrgEmployeeBreadcrumbs('admin', '/admin/organizations', {
          orgCardHref: `/admin/organizations/${id}`,
          orgName: org.name,
