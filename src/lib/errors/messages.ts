...
const RU: Record<string, string> = {
  ...
  options_required:
    'Для типов «выбор одного» и «множественный выбор» укажите хотя бы один вариант.',
  ...
  // Коды, которые сегодня обрабатываются структурно (диалогом со списком, кодом
  // HTTP), но текста не имели. Стоит новому экрану показать такой код обычной
  // строкой — человек увидел бы «Ошибка: access_denied». Текст добавлен заранее,
  // а страж `errors.codes-covered.guardrail` не даст завести код без перевода.
  access_denied: 'Нет доступа к этой заявке.',
  company_not_configured: 'Компания не настроена для обмена с 1С.',
  conflicts: 'Откат невозможен: данные уже изменились после импорта.',
  conversation_not_found: 'Переписка не найдена.',
  duplicate_found: 'Похожий сотрудник уже есть — проверьте совпадения.',
  inactive: 'Учётная запись отключена. Обратитесь к администратору.',
  invalid_file_format: 'Файл не похож на то, чем назван. Проверьте формат.',
  message_not_found: 'Сообщение не найдено.',
  not_generated: 'Файл ещё не сформирован. Попробуйте чуть позже.',
  not_ready: 'Заказ ещё не готов к выдаче.',
  organization_context_not_found: 'У заказа нет организации — загрузка невозможна.',
  quarantined: 'Файл на карантине: антивирус нашёл угрозу.',
  target_is_orphan: 'У цели нет компании — привязка невозможна.',
  target_not_found: 'Цель привязки не найдена.',
  too_short: 'Введите хотя бы два символа.',
