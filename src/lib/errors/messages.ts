...
const RU: Record<string, string> = {
  ...
  not_acceptable: 'Принять можно акт, договор или доп. соглашение. Счёт отмечается оплаченным по платежам, а не вручную.',
  ...
  not_lifecycle_type: 'У этого типа документа нет статусов — статус меняется только у счёта, акта, договора и доп. соглашения.',
