...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  contact_archived: 'Контакт отправлен в архив',
  contact_channel_added: 'Добавлен канал связи контакта',
  contact_channel_removed: 'Удалён канал связи контакта',
  contact_created: 'Создание контакта',
  contact_merged: 'Объединение контактов',
  contact_restored: 'Контакт возвращён из архива',
  contact_updated: 'Изменение контакта',
  organization_note_created: 'Создание внутренней заметки',
  organization_note_deleted: 'Удаление внутренней заметки',
  organization_note_pinned: 'Закрепление внутренней заметки',
  organization_note_updated: 'Изменение внутренней заметки',
  ...
  bitrix_import_previewed: 'Предпросмотр миграции из Битрикс24',
  bitrix_import_report_downloaded: 'Скачивание отчёта миграции из Битрикс24',
  bitrix_import_rolled_back: 'Откат миграции из Битрикс24',
  ...
  order_merged_into: 'Объединение заказа с заказом 1С',
  ...
  automation_rule_created: 'Создание правила автоматизации',
  automation_rule_deleted: 'Удаление правила автоматизации',
  automation_rule_disabled: 'Выключение правила автоматизации',
  automation_rule_enabled: 'Включение правила автоматизации',
  automation_rule_updated: 'Изменение правила автоматизации',
...
const ENTITY_LABELS: Record<AuditEntity, string> = {
  ...
  bitrix_import_batch: 'Пакет миграции из Битрикс24',
  ...
  contact: 'Контакт',
  organization_note: 'Внутренняя заметка',
