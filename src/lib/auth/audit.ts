...
export const AUDIT_ENTITIES = [
  ...
  'auth_2fa',
  'contact',
  // Этап 1 ТЗ 12.09.2026 (`У-183`): внутренняя заметка по организации.
  'organization_note',
  'call',
  'inbound_message',
...
export const AUDIT_ACTIONS = [
  ...
  'organization_note_created',
  'organization_note_deleted',
  'organization_note_pinned',
  'organization_note_updated',
