 ...
 */
test('manager contacts list renders consistently', async ({ page }, testInfo) => {
  await page.goto('/manager/contacts');
  await page.waitForLoadState('networkidle');

  await expect(page).toHaveScreenshot(`manager-contacts-${testInfo.project.name}.png`, {
    fullPage: true,
  });
});
