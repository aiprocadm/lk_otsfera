...
describe('ManagerSidebar', () => {
  it('renders 19 nav links including Заявки, Воронка, Задачи, Календарь, Заявки на обучение, Обращения, Звонки, Финансы, Команда, Кабинет руководителя и Настройки (from raw canon)', () => {
