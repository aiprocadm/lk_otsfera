...
describe('ManagerSidebar', () => {
  it('renders 18 nav links including Заявки, Воронка, Задачи, Заявки на обучение, Обращения, Звонки, Финансы, Команда, Кабинет руководителя и Настройки (from raw canon)', () => {
