...
describe('AttentionList', () => {
  ...
  it('renders a stuck order with updatedAt', () => {
    const data: Attention = {
      ...empty,
      stuckOrders: [{ id: 'o1', title: 'Заказ А', updatedAt: new Date('2026-01-01'), deadline: null, totalAmount: '100', paidAmount: '0' }]
    };
  ...
  it('renders an overdue order with a deadline', () => {
    const data: Attention = {
      ...empty,
      overdueOrders: [{ id: 'o2', title: 'Заказ Б', updatedAt: new Date('2026-01-01'), deadline: new Date('2026-02-01'), totalAmount: '100', paidAmount: '0' }]
    };
    const html = renderToString(React.createElement(AttentionList, { data }));
  ...
  it('renders an overdue order with no deadline as em-dash', () => {
    const data: Attention = {
      ...empty,
      overdueOrders: [{ id: 'o3', title: 'Заказ В', updatedAt: new Date('2026-01-01'), deadline: null, totalAmount: '100', paidAmount: '0' }]
    };
    const html = renderToString(React.createElement(AttentionList, { data }));
