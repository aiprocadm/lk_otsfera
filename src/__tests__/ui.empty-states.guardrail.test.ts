...
const ALLOWED = new Set([
  ...
  // `У-218`: обсуждение и история на карточке задачи — два блока внутри одного
  // экрана, у которого есть и заголовок, и подзаголовок, и действия. Форма
  // ответа стоит прямо под текстом «Обсуждения пока нет», то есть «что делать
  // дальше» видно без отдельной серой плитки с картинкой.
  join('tasks', 'task-comments.tsx'),
  join('tasks', 'task-page-screen.tsx'),
