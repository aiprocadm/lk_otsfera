  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      ...
      <p className="mt-1 text-sm text-gray-500">
        Одноразовые коды на случай, если у вас нет доступа к почте при входе. Сгенерируйте и
        сохраните их в надёжном месте — они показываются один раз.
      </p>

      {codes ? (
        <div className="mt-3">
          <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
            Сохраните эти коды сейчас — после закрытия страницы они больше не покажутся. Прежние
            коды восстановления аннулированы.
          </div>
