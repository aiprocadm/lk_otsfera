...
const ERROR_MAP: Record<string, string> = {
  ...
  role_transition_forbidden:
    'Этот переход роли не поддерживается. Деактивируйте пользователя и создайте нового.',
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {isSelf && <p className="text-xs text-gray-500 mt-1">Нельзя деактивировать себя.</p>}
      </div>
