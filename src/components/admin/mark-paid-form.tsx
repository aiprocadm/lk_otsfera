      ...
      {open && (
        <div className="border border-gray-200 rounded-xl p-4 bg-white space-y-3">
          <div className="text-sm text-gray-700">
            Подтвердите, что комиссия по этому отчёту фактически переведена партнёру. Действие
            необратимо: статус сменится с <strong>approved</strong> на <strong>paid</strong>, а в
            audit log появится запись с вашим userId.
          </div>
          {error && (
