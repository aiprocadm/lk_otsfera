...
const FLAG_LABELS: Record<FeatureFlag, string> = {
  ...
  bitrix_migration:
    'Миграция из Битрикс24 — раздел «Интеграции → Миграция из Битрикс24», пакеты, очередь bitrix.import',
  comm_center:
    'Коммуникационный центр v2 — «Шаблоны ответов», раздел «Сайт» и приём заявок с формы',
  automation: 'Правила автоматизации — «событие → задача или уведомление» и журнал срабатываний',
