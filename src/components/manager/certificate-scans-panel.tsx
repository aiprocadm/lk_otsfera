...
const FILE_ERROR_RU: Record<ScanFileError, string> = {
  ...
  // `У-151`: у заказа нет компании-исполнителя — приписать скан неизвестному
  // юрлицу нельзя, и это не сбой хранилища, а незаполненные данные заказа.
  org_no_company: 'У заказа не указана компания-исполнитель — обратитесь к администратору.',
};
