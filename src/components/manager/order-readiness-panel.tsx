...
import { ITEM_GAP_RU, ORDER_GAP_RU, type OrderReadiness } from '@/lib/orders/readiness';
import {
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-3">
      ...
      {delivered && (
        <p className="text-sm text-gray-500">
          Клиент получил уведомление. Повторная передача не требуется — довоз результата обсуждайте
