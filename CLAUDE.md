...
### Состояние на 21.08.2026 — заведена программа ТЗ кабинетов, документов и интеграций

Программа ТЗ понятности закрыта 13.08.2026, программа роли руководителя —
18.08.2026. **21.08.2026 заказчик ввёл новое ТЗ** (10 этапов, `У-78`…`У-176`).
Этап 0 (переключение указателя, реестры) отгружается PR ввода ТЗ; после его
мержа **текущий этап — 1 «хотфикс выписки 51: организации без ИНН»**, спека
ещё не написана. Актуальную картину всегда бери из `STATUS.md`: этот абзац —
