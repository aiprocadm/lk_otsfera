...
[MAINTENANCE.md](docs/tz/MAINTENANCE.md). Два полных прогона `С-1`…`С-10`
выполнены 05.09.2026, шесть хотфиксов (#498…#503) влиты; три вопроса
заказчику (`В-1`…`В-3`) в `STATUS.md`. Актуальную картину всегда бери из
