...
[MAINTENANCE.md](docs/tz/MAINTENANCE.md). Двенадцать полных прогонов `С-1`…`С-10`
выполнены 05–07.09.2026, восемнадцать хотфиксов (#498…#527) влиты (двенадцатый
прогон дефектов не нашёл); три вопроса
