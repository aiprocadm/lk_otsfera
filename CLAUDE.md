...
(#401…@@PR3@@), 99 требований `У-78`…`У-176` в `✅`, close-out —
...
[MAINTENANCE.md](docs/tz/MAINTENANCE.md). Первый полный прогон `С-1`…`С-10`
выполнен 05.09.2026; в очереди три хотфикса (матрица флагов, страж подсказки
«200 МБ», `npm audit fix`) и два вопроса заказчику в `STATUS.md`. Актуальную
картину всегда бери из `STATUS.md`: этот абзац — снимок на дату и может отстать.
