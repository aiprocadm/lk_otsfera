...
### Состояние на 13.09.2026 — программа «CRM для отдела продаж — замена Битрикс24», этапы 1 и 2 закрыты, текущий этап 3
...
93 требования `У-177`…`У-269` в AUDIT.md. **Этап 1 «Контакты и внутренние
заметки» закрыт 13.09.2026** (`У-178`…`У-187` ✅; спека #585, PR #586, #588,
#589, #590, #591; close-out
[2026-09-12-stage1-contacts-and-notes-DONE.md](docs/superpowers/plans/2026-09-12-stage1-contacts-and-notes-DONE.md));
флаг `contacts` выключен до приёмки заказчиком, вкладка «Задачи» контакта —
этап 4. **Этап 2 «Миграция из Битрикс24» закрыт 13.09.2026** (`У-188`…`У-203` ✅;
спека #596, PR #597…#602; close-out
[2026-09-13-stage2-bitrix-migration-DONE.md](docs/superpowers/plans/2026-09-13-stage2-bitrix-migration-DONE.md));
флаг `bitrix_migration` выключен до приёмки, еженедельный повтор `bitrix.resync`
на паузе, выключение Битрикс24 — работа заказчика по
[runbook](docs/integrations/bitrix24-migration.md). **Текущий этап — 3
«Коммуникационный центр v2»** (`У-204`…`У-217`); шаг — сверка кода по §16 и
спека этапа в `docs/superpowers/specs/` **не написана**, предъявить заказчику
до кода. Открытые вопросы
`В-Б-1`…`В-Б-6` — в `STATUS.md`. Режим сопровождения не остановлен: хотфиксы
§9.4 идут параллельно, полные прогоны `С-1`…`С-10` — при закрытии этапов и по
просьбе заказчика. CI GitHub Actions с 12.09.2026 не запускается (аккаунт
