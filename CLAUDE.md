...
[MAINTENANCE.md](docs/tz/MAINTENANCE.md). Шесть полных прогонов `С-1`…`С-10`
выполнены 05–06.09.2026, тринадцать хотфиксов (#498…#515) влиты (шестой прогон
дефектов не нашёл); три вопроса
