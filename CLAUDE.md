...
### Состояние на 13.09.2026 — программа «CRM для отдела продаж — замена Битрикс24», этап 1 закрыт, текущий этап 2
...
этап 4. **Текущий этап — 2 «Миграция из Битрикс24»** (`У-188`…`У-203`,
[16_bitrix24_migration.md](docs/specs/16_bitrix24_migration.md), задачи
Task 5…10 в [15_claude_code_tasks.md](docs/specs/15_claude_code_tasks.md));
шаг — сверка кода по §16 и спека этапа в `docs/superpowers/specs/` **не
написана**, предъявить заказчику до кода; до спеки нужен ответ на `В-Б-3`
(тариф Битрикс24, REST и файлы), иначе действует умолчание. Открытые вопросы
